...
echo "   → See QUICK-START-PROMOTION.md for full instructions"
echo ""
...
echo "   - QUICK-START-PROMOTION.md (how to use the enhancement)"
echo "   - development/demo_subdirectory_benefits.sh (technical demo)"
echo ""
