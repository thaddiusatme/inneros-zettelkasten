...
- **Next**:
  - Phase 4-5: Batch inbox processing + `make inbox` (GitHub issue #80)
...
- **[Next]** Phase 4-5 — Batch inbox processing + `make inbox` (see `prompt-phase-4-5-batch-inbox-processing.md`)
