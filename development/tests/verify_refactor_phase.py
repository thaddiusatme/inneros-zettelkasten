...
def test_dashboard_launcher_facade():
    ...
    assert isinstance(launcher.launcher, WebDashboardLauncher), "Should use WebDashboardLauncher"
...
def test_terminal_dashboard_launcher_facade():
    ...
    assert hasattr(launcher, 'launcher'), "Should have launcher attribute"
    assert isinstance(launcher.launcher, LiveDashboardLauncher), "Should use LiveDashboardLauncher"
...
def test_dashboard_orchestrator():
    ...
    assert isinstance(orchestrator.web_launcher, DashboardLauncher), "Should use DashboardLauncher"
    assert isinstance(orchestrator.terminal_launcher, TerminalDashboardLauncher), "Should use TerminalDashboardLauncher"
    ...
    with patch.object(orchestrator.terminal_launcher.launcher, 'launch') as mock_terminal:
