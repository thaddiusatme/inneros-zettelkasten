...
class TestDaemonDetector:
    ...
    def test_detects_running_daemon_by_name(self):
        ...
        with patch("psutil.process_iter") as mock_process_iter:
            ...
            status = detector.check_daemon_status(
    ...
    def test_handles_multiple_daemons(self):
        ...
        with patch("psutil.process_iter") as mock_process_iter:
            ...
            mock_proc2.info = {
                ...
                "cmdline": [
                    "/usr/bin/python3",
                    ".automation/scripts/health_monitor.py",
                ],
            }
...
class TestAutomationStatusCLI:
    ...
    def test_status_command_shows_all_daemons(self, mock_daemon_registry, tmp_path):
        ...
        cli = AutomationStatusCLI(
            registry_path=mock_daemon_registry, workspace_root=tmp_path
        )
    ...
    def test_last_run_command_shows_execution_details(
        self, mock_daemon_registry, mock_log_file, tmp_path
    ):
    ...
    def test_logs_command_displays_tail(
        self, mock_daemon_registry, mock_log_file, tmp_path
    ):
