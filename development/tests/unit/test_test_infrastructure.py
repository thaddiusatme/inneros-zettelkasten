...
def test_evening_screenshot_utils_exports():
    ...
    test_file_2 = Path(__file__).parent / "test_evening_screenshot_processor_green_phase.py"
    ...
    assert "pytestmark = pytest.mark.skip" in content_2, "Missing skip marker in green_phase"
...
def test_automation_modules_exist():
    ...
    assert "pytestmark = pytest.mark.skip" in content, "Missing skip marker in automation test"
