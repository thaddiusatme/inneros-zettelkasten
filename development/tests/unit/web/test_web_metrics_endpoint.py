...
class TestWebMetricsEndpoint:
    ...
    def test_metrics_response_has_current_metrics(self, client):
        ...
        assert 'current' in data, \
            "Response must include 'current' metrics section"
    ...
    def test_current_metrics_has_counters(self, client):
        ...
        assert 'counters' in current, \
            "Current metrics must include 'counters' section"
    ...
    def test_current_metrics_has_gauges(self, client):
        ...
        data = response.get_json()
        current = data.get('current', {})
        assert 'gauges' in current, \
            "Current metrics must include 'gauges' section"
    ...
    def test_metrics_response_has_history(self, client):
        ...
        assert 'history' in data, \
            "Response must include 'history' field for trending"
