...
"""
        ...
        with patch.object(handler.transcript_saver, "save_transcript") as mock_save:
            expected_transcript_path = (
                ...
                / "Media"
                / "Transcripts"
                / "youtube-dQw4w9WgXcQ-2025-10-17.md"
            )
...
"""
        ...
        assert (
            "transcript_file" in result
        ), "Result should include 'transcript_file' key"
...
"""
        ...
        assert (
            "youtube-test_video_123-" in wikilink
