...
class TestSamsungCaptureCentralizedStorage(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_screenshot = (
            self.onedrive_path / "Screenshot_20251002_120000_Chrome.jpg"
        )
    ...
    def test_new_screenshot_saved_to_centralized_attachments(self):
        ...
        with patch.object(
            self.processor.ocr_processor, "process_batch"
        ) as mock_ocr_process:
    ...
    def test_generated_note_uses_centralized_image_path(self):
        ...
        self.assertGreater(
            len(result["individual_note_paths"]),
            0,
    ...
    def test_original_screenshot_deleted_after_centralization(self):
        ...
        centralized_files = list(
            (self.knowledge_path / "attachments" / "2025-10").glob("samsung-*.jpg")
        )
    ...
    def test_existing_workflows_continue_working(self):
        ...
        for key in expected_keys:
            self.assertIn(
                key, result, f"Result should contain {key} for backward compatibility"
            )
...
"""
    ...
    def test_device_prefix_applied_correctly(self):
        ...
        samsung_screenshot = (
            self.onedrive_path / "Screenshot_20251002_143000_Messenger.jpg"
        )
        ...
        with patch.object(
            ...
            with patch.object(
                self.processor.screenshot_detector,
                "scan_todays_screenshots",
