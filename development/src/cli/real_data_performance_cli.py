...
class RealDataPerformanceCLI:
    ...
    def _run_concurrent_processing_benchmark(self, options: Dict[str, Any]) -> Dict[str, Any]:
        ...
        note_sets = [
            self._generate_test_notes(20, f"concurrent_session_1"),
            self._generate_test_notes(15, f"concurrent_session_2"),
            self._generate_test_notes(25, f"concurrent_session_3")
        ]
