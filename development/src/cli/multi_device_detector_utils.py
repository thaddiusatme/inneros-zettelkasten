...
class DevicePatternMatcher:
    ...
    def __init__(self):
        ...
        self.patterns = {
            DeviceType.SAMSUNG_S23: re.compile(
                r"^Screenshot_(\d{8})_(\d{6})_(.+)\.jpg$"
            ),
...
class DeviceMetadataBuilder:
    ...
    def __init__(
        self,
        pattern_matcher: DevicePatternMatcher,
    ...
    def build(
        self, file_path: Path, device_type: DeviceType, timestamp: Optional[datetime]
    ) -> Dict[str, Any]:
        """
