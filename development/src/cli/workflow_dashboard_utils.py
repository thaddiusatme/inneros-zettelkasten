...
class CLIIntegrator:
    ...
    def call_cli(self, cli_name: str, args: List[str]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"returncode": -1, "data": {}, "error": "CLI timeout"}
        except Exception as e:
            return {"returncode": -1, "data": {}, "error": str(e)}
...
class StatusPanelRenderer:
    ...
    def format_inbox_metrics(
        self, inbox_count: int, oldest_age_days: Optional[int] = None
    ) -> str:
        """
...
class ActivityLogger:
    ...
    def log_operation(self, action: str, result: str, status: str = "success"):
        """
        Log an operation.
...
class AsyncCLIExecutor:
    ...
    def __init__(
        self,
        timeout: int = 60,
        progress_manager: Optional["ProgressDisplayManager"] = None,
    ):
        """
    ...
    def execute_with_progress(
        self, cli_name: str, args: List[str], vault_path: str = "."
    ) -> Dict[str, Any]:
        """
