...
class StatusPanelRenderer:
    ...
    def create_inbox_panel(
        ...
        Returns:
            Rich Panel object or string (if Rich not available)
        """
        ...
        panel_content = Text()
        panel_content.append(f"Notes: {inbox_count} {health_indicator}\n")
        
        if oldest_age_days is not None:
            panel_content.append(f"Oldest: {oldest_age_days // 30} months\n")
        
        panel_content.append("Action: Process inbox")
