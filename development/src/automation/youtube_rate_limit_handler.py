...
class YouTubeRateLimitHandler:
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self.max_retries = int(
            self._validate_config(config.get("max_retries", 3), "max_retries", 0, 10)
        )
    ...
    def _validate_config(
        self, value: Any, name: str, min_val: float, max_val: float
    ) -> float:
    ...
    def _classify_error(self, exception: Exception) -> bool:
        ...
        if isinstance(
            exception, (VideoUnavailable, TranscriptsDisabled, NoTranscriptFound)
        ):
            return False
    ...
    def get_retry_statistics(self) -> Dict[str, Any]:
        ...
        with self._metrics_lock:
            ...
            return {
                ...
                "avg_attempts": total
                / max(self._metrics["succeeded"] + self._metrics["failed"], 1),
            }
